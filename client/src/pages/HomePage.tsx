    ...
    <main className="relative z-[1] min-h-screen px-6 pb-12 pt-[7.5rem] animate-[page-fade_320ms_ease-out]">
      <section className="mx-auto flex w-full max-w-[70rem] min-h-[calc(100vh-11rem)] flex-col items-center justify-center gap-6 text-center">
        <div className="relative grid h-28 w-28 place-items-center rounded-full bg-surface-highest/92 shadow-soft">
          ...
          <span className="material-symbols-outlined text-[2.5rem] text-primary">
            diversity_3
          </span>
        </div>
        ...
        <p className="max-w-[18rem] text-text-muted leading-[1.65]">
          Connect instantly with a random person. Keep it respectful, keep it
          real.
        </p>
        ...
        <div className="grid w-full grid-cols-2 gap-4 max-[767px]:grid-cols-1">
          <FeatureCard
            icon="lock"
            subtitle="Your identity stays hidden until you share it."
            title="Anonymous"
          />
          <FeatureCard
            icon="bolt"
            subtitle="Get matched in seconds and keep the flow fast."
            title="Instant"
          />
        </div>
      </section>
