...
function RegisterPage({ onRegister }: RegisterPageProps) {
  const [alias, setAlias] = useState('GhostWalker');
      ...
      <section className="flex w-full max-w-[26rem] flex-col gap-[1.75rem] animate-[page-fade_320ms_ease-out]">
        ...
        <div className="relative rounded-3xl border border-outline bg-[#1f1f23]/88 p-8 shadow-main">
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <Field icon="person" label="Anonymous Alias" onChange={setAlias} value={alias} />
            <Field icon="alternate_email" label="Deep Mail" onChange={setEmail} type="email" value={email} />
