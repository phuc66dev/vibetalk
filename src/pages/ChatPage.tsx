...
function ChatPage({ messages, onOpenReport, onSend, onSkip, strangerTyping }: ChatPageProps) {
  ...
  return (
    <main className="relative z-[1] flex min-h-screen flex-col px-6 pb-[6rem] pt-[6rem] animate-[page-fade_320ms_ease-out]">
      <TopBar chatMode onOpenReport={onOpenReport} onSkip={onSkip} />
      <section className="mx-auto flex w-full max-w-[70rem] flex-1 flex-col pb-4">
        <div className="flex-1 flex flex-col gap-[1.4rem] px-6 py-4 pb-28 overflow-y-auto scrollbar-thin scrollbar-thumb-surface-highest" ref={streamRef}>
